...
# 2026-06 按国产大模型实测能力更新:每个 agent 用"该角色最强能力"的国产模型当主力,
# 配一个更省的 fallback(走 agent 的备用通道)。CEO/规划推荐 DeepSeek-V4-Pro(性价比之王)。
RECOMMENDATIONS = {
    "coder": {"model": "kimi-k2.6", "fallback": "qwen3-coder-flash",
              "reason": "Kimi 国产最强代码模型(SWE-Bench Pro 58.6),擅长 agentic 多文件改造;省钱退 Qwen3-Coder-Flash 跑日常生成。",
              "providers": ["moonshot", "openrouter"]},
    "writer": {"model": "glm-5.1", "fallback": "qwen3.7-plus",
               "reason": "GLM-5.1 国产中文推理+文风最强,小红书/公众号/脚本质感稳;省钱退 Qwen3.7-Plus。",
               "providers": ["zhipu", "openrouter"]},
    "researcher": {"model": "qwen3.7-plus", "fallback": "deepseek-v4-flash",
                   "reason": "Qwen3.7-Plus 1M 上下文 + 多模态文档检索,一次吞下整批资料;更省退同为 1M 的 DeepSeek-V4-Flash。",
                   "providers": ["dashscope", "openrouter"]},
    "analyst": {"model": "glm-5", "fallback": "step-3.7-flash",
                "reason": "GLM-5 国产数学/推理最强,财务建模/策略推演稳;便宜近似退 Step-3.7-Flash(AIME 97.3)。",
                "providers": ["zhipu", "openrouter"]},
    "builder": {"model": "deepseek-v4-flash", "fallback": "hunyuan-hy3",
                "reason": "DeepSeek-V4-Flash 指令遵循可靠且极便宜,合同/邮件/纪要够用;批量退 Hunyuan-HY3 更省。",
                "providers": ["deepseek", "openrouter"]},
    "runner": {"model": "doubao-seed-1.6-flash", "fallback": "hunyuan-hy3",
               "reason": "Doubao-Seed-1.6-Flash 全网最便宜最快($0.022/$0.219),批量搬运/格式转换/日志不心疼。",
               "providers": ["ark", "openrouter"]},
    "perceiver": {"model": "doubao-seed-2.0", "fallback": "qwen3-vl-plus",
                  "reason": "Doubao-Seed-2.0-Pro 国产视频理解最强(VideoMME 89.5),抖音视频只能它;图片/文档可退 Qwen3-VL-Plus。",
                  "providers": ["ark"]},
}
...
KNOWN_MODELS = {
    ...
    "zhipu": ["glm-5", "glm-5.1", "glm-5-air", "glm-5-flash", "glm-4.7-flash", "glm-4-plus", "glm-4-flash"],
    "dashscope": ["qwen3.7-max", "qwen3.7-plus", "qwen3.7-turbo", "qwen3-coder-plus", "qwen3-coder-flash",
                  "qwen3-vl-plus", "qwen-max", "qwen-plus", "qwen-vl-max"],
    "moonshot": ["kimi-k2.7-code", "kimi-k2.6", "kimi-k2", "moonshot-v1-128k", "moonshot-v1-32k", "moonshot-v1-8k"],
    "openai": ["gpt-5.1", "gpt-5.1-mini", "codex-5.5", "o4", "o4-mini", "gpt-4.1"],
    "ark": ["doubao-seed-2.0", "doubao-seed-2.0-pro", "doubao-seed-1.6-flash", "doubao-seed-2.0-lite",
            "doubao-pro-32k", "doubao-vision-pro", "doubao-lite-128k"],
    "openrouter": ["deepseek/deepseek-v4-pro", "deepseek/deepseek-v4-flash", "qwen/qwen3.7-plus",
                   "qwen/qwen3-coder-flash", "moonshotai/kimi-k2.6", "zhipu/glm-5.1",
                   "stepfun/step-3.7-flash", "minimax/minimax-m2.7", "openai/codex-5.5",
    ...
    "minimax": ["minimax-m2.7", "minimax-m2", "abab7-chat", "minimax-vl-01"],
    "stepfun": ["step-3.7-flash", "step-3", "step-2-16k", "step-1v-8k"],
    "hunyuan": ["hunyuan-hy3", "hunyuan-turbo-s", "hunyuan-large", "hunyuan-vision"],
